...
-- Возвращает все строки из таблицы "departments", где значение в столбце "department_name" точно соответствует строке 'IT'.
-- select * from departments
-- where department_name like 'IT';
-- where department_name = 'IT';

-- Возвращает все строки из таблицы "departments", где значение в столбце "department_name" содержит подстроку 'IT' в любом месте строки.
-- select * from departments
-- where department_name like '%IT';

-- Возвращает все строки из таблицы "departments", где значение в столбце "department_name" начинается с подстроки 'IT'.
-- select * from departments
-- where department_name like 'IT%';
...
-- Возвращает все строки из таблицы "departments", где значение в столбце "department_name" начинается с буквы 'A', а затем следует подстрока, содержащая 'N'.
-- select * from departments
...
-- Вывести сотрудников, укоторых в фамилии в
-- середине слова встречаются сочетания ‘kk’ или ‘ll’
...
-- select * from employees
-- where email like '______' and email like 'K%';
...
-- Найти сотр. которыеплатят комисси
-- select * from employees
-- where commission_pct is not null;

-- Найти сотр. которые не платят комисси
-- select * from employees
-- where commission_pct is null;

-- Вывести всех сотрудников с job_id ‘FI_ACCOUNT’ и 
-- зарабатывающих меньше 8000, которые не платят комиссии
-- select * from employees
